...
class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        Phaser.Actions.Call(this.enemies.getChildren(), (enemy) => {
            ...
            const velocity = Phaser.Math.RND.realInRange(this.enemyMinSpeed,this.enemyMaxSpeed);

            enemy.setData('speed',velocity*dir);
        })
    ...
    update() {
        ...
        Phaser.Actions.Call(this.enemies.getChildren(), (enemy) => {
            ...
            const reachedTop = enemy.getData('speed') < 0 && enemy.y < this.lowerLimit;

            const reachedBottom = enemy.getData('speed') > 0 && enemy.y > this.upperLimit;
